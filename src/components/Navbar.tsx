  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm border-b border-[#C7A14A]/30">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button 
              ...
              className="text-white/90 hover:text-[#C7A14A] transition-colors duration-300"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-[#C7A14A]/30">
            <div className="flex flex-col space-y-4 pt-4">
              <button
                onClick={scrollToLocations}
                className="text-left text-white/90 hover:text-[#C7A14A] transition-colors duration-300 font-light py-2"
              >
                Locales
              </button>
              <button
              ...
              <button
                onClick={handleLogin}
                className="w-full px-6 py-2 bg-[#C7A14A] text-black hover:bg-[#d4b056] hover:scale-105 transition-all duration-300 font-light rounded-lg text-left"
              >
                Login
              </button>
            </div>
